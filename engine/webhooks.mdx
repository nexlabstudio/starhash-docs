...
curl -X POST http://localhost:8080/hooks/africas_talking/inst_test \
  -d "sessionId=test123&phoneNumber=%2B233201234567&text=&serviceCode=*123#"

# Hubtel format
curl -X POST http://localhost:8080/hooks/hubtel/inst_test \
  -H "Content-Type: application/json" \
  -d '{"SessionId":"test123","Mobile":"233201234567","Message":"","Type":"Initiation"}'
```

### Using ngrok

Expose your local server for provider testing:
...
```
https://abc123.ngrok.io/hooks/africas_talking/inst_test
```
