...
### Can I test on a real phone?

Yes! Download the Companion app for iOS or Android. It lets you test flows on real devices.

### Does testing cost money?

No! Simulator and Companion app testing is free. Only production traffic incurs charges from your USSD provider.
...
Yes! StarHash has a full REST API. See the [API Reference](/engine/api-reference) for documentation.
