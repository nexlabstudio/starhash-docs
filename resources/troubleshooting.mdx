...
### Can't sign in to Companion app

**Solutions**:
1. Use the same account as Studio
2. Check internet connection
3. Update the app to latest version
4. Try signing out and back in

### Flows not appearing in app

**Solutions**:
1. Pull down to refresh
2. Check you're on the correct workspace
3. Flows sync every 30 seconds
